...
const Footer = () => {
  ...
  <div>
    <img height={'200px'} src={logo} alt="" />
     <h2 className='text-[#5858c6] text-xl'>Kids sports</h2>
     <small><p className='text-[#5858c6] text-xl'>©Kids sports 2023</p></small>
    
  
  </div> 
  <div>
    <span className="footer-title">Address and Contact information</span> 
    <h3 className='text-[#5858c6] text-xl'>  Badagatt,Sylhet,Bangladesh</h3>
     
    <h3 className='text-[#5858c6] text-xl' >  Email: kidssports@gmail.com</h3>
    
    <h3 className='text-[#5858c6] text-xl'>  Helpline: 01748137101</h3>
    
     
  </div> 
  <div>
  <span className="footer-title">Useful Links</span>
    <a  className="text-[#5858c6] text-xl hover:text-[#a7a705]">About us</a> 
